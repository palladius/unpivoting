// Thanks Viktor: https://stackoverflow.com/questions/24954722/how-do-you-create-a-reverse-pivot-in-google-sheets
...
function unpivotTestRatings() {
  ret = unpivot([
      ["email","Ratings [How do you like Tagliatelle Alfredo?]", "Ratings [How do you like Pizza Chicago style?]"],
      ["anonymous@domain.com", 3,1]
    ],
    3,1,
    "RatingsKey","RatingsValue")  ;
  //print(ret); // for debug
  return ret;
}